...
If the stock is a Turkish company. Their tickers end with .IS, Interest Rate on Debt (interest_rate_debt) should be at least 0.25. You can suggest higher based on current market conditions.
